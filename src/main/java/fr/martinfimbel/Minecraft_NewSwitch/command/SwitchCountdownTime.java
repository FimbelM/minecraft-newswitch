...
public class SwitchCountdownTime extends AbstractLabelEdition<ISwitchConfiguration> {

	public SwitchCountdownTime() {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		try {
			get().setSwitchCountdownTime(LocalTime.parse(args[0]));
			sendSynchro(sender, ESwitchMessageCode.NUMBER_OF_SECONDS_DEFINED, DisplayHelper.toString(get().getSwitchCountdownTime(), false));
			return true;
